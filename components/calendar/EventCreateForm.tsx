      ...
      <div className="grid gap-3 grid-cols-2 lg:grid-cols-4">
        ...
        <label className="block min-w-0 text-sm text-zinc-300">
          ...
          <div className="mt-2 overflow-hidden rounded-md">
            <input className="h-10 w-full rounded-md border border-white/10 bg-[#101114] px-3 text-sm text-white" type="datetime-local" value={startAt} onChange={(event) => setStartAt(event.target.value)} required />
          </div>
        </label>
        <label className="block min-w-0 text-sm text-zinc-300">
          종료
          <div className="mt-2 overflow-hidden rounded-md">
            <input className="h-10 w-full rounded-md border border-white/10 bg-[#101114] px-3 text-sm text-white" type="datetime-local" value={endAt} onChange={(event) => setEndAt(event.target.value)} />
          </div>
        </label>
        <label className="block min-w-0 text-sm text-zinc-300">
          장소
