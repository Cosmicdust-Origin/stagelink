...
const CollapsibleContext = createContext<{ close: () => void }>({ close: () => {} });

export function useCollapsibleClose() {
  return useContext(CollapsibleContext).close;
}
...
export function CollapsibleSection({
  ...
  return (
    <CollapsibleContext.Provider value={{ close: () => setOpen(false) }}>
      <div>
        <button
          type="button"
          onClick={() => setOpen((v) => !v)}
